...
$response = json_decode(get_all_submission_of_a_user_on_a_problem_with_pageno($_SESSION['config'],$_SESSION['outh'],$contestCode,$problemCode,$page,$_SESSION['config']['user_name']),true);
...
<div class="row mysubmission">
    <h2>My submission</h2>
    <?php 
    if (array_key_exists("content",$res)==true ){
    ?>
    <table  class="ranklist table table-bordered" style ="text-align:center;" style="overflow-x:auto;">
    <tr>
    ...
    <?php 
        ...
        ?>
    <h3 style="text-align:center;">No submission<h3>
    <?php
        }
    ?>
</div>
<div class="row" style="text-align:center;">
    ...
    <?php
        ...
        echo "class='disabled'";
    ?>
        ><a href="mysubmission.php?contestCode=<?php echo $contestCode; ?>&problemCode=<?php echo $problemCode; ?>&page=<?php echo $page-1; ?>">
    ...
    <?php
        ...
        ><a href="mysubmission.php?contestCode=<?php echo $contestCode; ?>&problemCode=<?php echo $problemCode; ?>&page=<?php echo $page; ?>">
        <?php echo $page;?></a></li>
        <?php
